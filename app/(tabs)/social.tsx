    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      {sub==='Clubs'&&(()=>{
        ...
        return <View style={{padding:spacing.lg}}>
          ...
          {clubCreating?<View style={{marginTop:spacing.md,gap:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.border,padding:14}}>
          ...
          </View>:<TouchableOpacity onPress={()=>setClubCreating(true)} style={{marginTop:spacing.md,padding:13,borderWidth:1,borderColor:colors.border,borderStyle:'dashed',alignItems:'center'}}><Text style={{fontFamily:fonts.sansMedium,fontSize:13,color:colors.text2}}>+ Start a club</Text></TouchableOpacity>}
          <View style={{height:spacing.md}}/>
          {allC.map(c=><TouchableOpacity key={c.id} onPress={()=>{setClubOpenId(c.id.startsWith('club-')?c.id:null);setShowClub(true);}} style={{backgroundColor:colors.surface,borderWidth:1,borderColor:colors.border,padding:spacing.lg,marginBottom:10}}>
      ...
      {sub==='Challenges'&&(()=>{
        ...
        return <View style={{padding:spacing.lg}}>
          ...
          {chCreating?<View style={{marginTop:spacing.md,gap:8,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.border,padding:14}}>
            ...
            <View style={{flexDirection:'row',gap:8}}>
              <TouchableOpacity style={{flex:1,backgroundColor:colors.accent,padding:11,alignItems:'center'}} onPress={()=>{if(chTitle.trim()){createChallenge(chTitle.trim(),chDesc.trim(),parseInt(chGoal)||12);setChTitle('');setChDesc('');setChGoal('12');setChCreating(false);}}}><Text style={{fontFamily:fonts.sansBold,fontSize:13,color:colors.bg}}>Create challenge</Text></TouchableOpacity>
          ...
          </View>:<TouchableOpacity onPress={()=>setChCreating(true)} style={{marginTop:spacing.md,padding:13,borderWidth:1,borderColor:colors.border,borderStyle:'dashed',alignItems:'center'}}><Text style={{fontFamily:fonts.sansMedium,fontSize:13,color:colors.text2}}>+ Create a challenge</Text></TouchableOpacity>}
          <View style={{height:spacing.md}}/>
          {allCh.map(ch=><TouchableOpacity key={ch.id} onPress={()=>setChallengeId(ch.id)} style={{backgroundColor:colors.surface,borderWidth:1,borderColor:ch.featured?colors.accent:colors.border,padding:spacing.lg,marginBottom:10}}>
...
const chip:any={paddingHorizontal:12,paddingVertical:7,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.border,maxWidth:150};
