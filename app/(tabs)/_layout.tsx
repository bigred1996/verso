...
function Icon({name,color}:{name:string;color:any}){
  ...
  switch(name){
    case 'today': return <Svg width={22} height={22} viewBox="0 0 24 24"><Path {...p} d="M12 3c1.6 3.4-1.4 4.8-1.4 7.2 0 1.4 1 2.3 1.4 2.3s1.4-.9 1.4-2.3c0-1.4-.5-2.3 0-3.2 1.9 1.4 3.6 3.7 3.6 6.8a5 5 0 0 1-10 0C7 9.6 9.6 6 12 3z"/></Svg>;
